...
var ONE_EIGHTH = CONSTANTS.CHALLENGE_RATING_TYPES.ONE_EIGHTH,
    EASY = CONSTANTS.STAGE_TYPES.EASY;

var Encounter = function () {
  function Encounter() {
    var difficultyClass = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ONE_EIGHTH;
    var stage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : EASY;
  ...
  _createClass(Encounter, [{
    ...
    value: function randomize() {
      this.monsters = [new _Monster2.default()];
    }
  }]);
