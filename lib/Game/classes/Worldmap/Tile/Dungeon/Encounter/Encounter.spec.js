...
describe('(Encounter)', function () {
  ...
  beforeEach(function () {
    return encounter = new _index2.default();
  });

  it('should default to as easy as possible', function () {
    (0, _chai.expect)(encounter.difficultyClass).to.equal(ONE_EIGHTH);
    (0, _chai.expect)(encounter.stage).to.equal(EASY);
  });
});