...
var _CONSTANTS$EQUIPMENT = CONSTANTS.EQUIPMENT,
    SHIELD = _CONSTANTS$EQUIPMENT.SHIELD,
    LEATHER_ARMOR = _CONSTANTS$EQUIPMENT.LEATHER_ARMOR,
    SCALE_MAIL = _CONSTANTS$EQUIPMENT.SCALE_MAIL,
    CHAIN_MAIL = _CONSTANTS$EQUIPMENT.CHAIN_MAIL,
    ARMOR_TYPES = CONSTANTS.ARMOR_TYPES,
    _CONSTANTS$ARMOR_TYPE = CONSTANTS.ARMOR_TYPES,
    LIGHT = _CONSTANTS$ARMOR_TYPE.LIGHT,
    MEDIUM = _CONSTANTS$ARMOR_TYPE.MEDIUM,
    HEAVY = _CONSTANTS$ARMOR_TYPE.HEAVY;
exports.default = (_SHIELD$LEATHER_ARMOR = {}, _defineProperty(_SHIELD$LEATHER_ARMOR, SHIELD, {
  name: 'shield',
  type: ARMOR_TYPES.SHIELD,
  armorClass: 2
}), _defineProperty(_SHIELD$LEATHER_ARMOR, LEATHER_ARMOR, {
  name: 'leather armor',
  type: LIGHT,
  armorClass: 11
}), _defineProperty(_SHIELD$LEATHER_ARMOR, SCALE_MAIL, {
  name: 'scale mail',
  type: MEDIUM,
  armorClass: 14
}), _defineProperty(_SHIELD$LEATHER_ARMOR, CHAIN_MAIL, {
  name: 'chain mail',
  type: HEAVY,
  armorClass: 16
}), _SHIELD$LEATHER_ARMOR);