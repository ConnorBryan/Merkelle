...
var HANDLERS = (_HANDLERS = {}, _defineProperty(_HANDLERS, GENERATE_WORLDMAP, function (state, action) {
  var worldmap = action.payload.worldmap;


  return _extends({}, state, {
    worldmap: worldmap
  });
}), _defineProperty(_HANDLERS, GENERATE_ENTITY, function (state, action) {
