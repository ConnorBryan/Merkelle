...
var P2P = function () {
  function P2P(config) {
    ...
    this.update = function () {
      _this.broadcast({
        type: _messageTypes2.default.UPDATE,
    ...
    this.requestAll = function () {
      _this.broadcast({
        type: _messageTypes2.default.REQUEST_ALL,
        data: {}
      });
    };
    ...
    this.handleMessage = function (message, socket) {
      ...
      switch (message.type) {
        case _messageTypes2.default.GREETING:
          ...
          break;
        case _messageTypes2.default.UPDATE:
  ...
  _createClass(P2P, [{
    ...
    value: function handleUpdate(chain) {
      ...
      if (blockchainIsBehind) {
        this.log(_constants2.default.BLOCKCHAIN_IS_BEHIND);

        if (hashesMatch) {
          this.log(_constants2.default.HASHES_MATCH);
          ...
          this.log(_constants2.default.REQUESTING_UPDATED_BLOCKCHAIN);
          this.requestAll();
        } else {
          this.log(_constants2.default.REPLACING_ENTIRE_BLOCKCHAIN);
          this.blockchain.chain = chain;
        }
      } else {
        this.log(_constants2.default.UP_TO_DATE);
      }
    }
  }, {
